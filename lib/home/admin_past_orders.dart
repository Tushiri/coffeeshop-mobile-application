...
class AdminPastOrders extends StatefulWidget {
  const AdminPastOrders({super.key});

  @override
  State<AdminPastOrders> createState() => AdminPastOrdersState();
}

class AdminPastOrdersState extends State<AdminPastOrders> {
  ...
  void initState() {
    super.initState();
    ordersFuture = firestore.getAllOrder('');
  }
